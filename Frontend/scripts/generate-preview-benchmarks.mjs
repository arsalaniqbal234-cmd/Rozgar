// Run from Frontend: node scripts/generate-preview-benchmarks.mjs
// The approved three samples also become production frame one; every field gets a second UI view.
...
function detail(category, item) {
  ...
  `;
  return frame(category, item.app, item.area + " activity", content);
}
